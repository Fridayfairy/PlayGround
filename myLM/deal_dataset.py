...
pretrain_data = '/mnt/34T/datasets/DataHub/ddzhu123/seq-monkey/mobvoi_seq_monkey_general_open_corpus.jsonl'
output_pretrain_data = '../data/seq_monkey_datawhale.jsonl'

# sft_data 为运行download_dataset.sh时，下载的sft_data本地路径
sft_data = '/mnt/34T/datasets/DataHub/BelleGroup/train_3.5M_CN.json'
